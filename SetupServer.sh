...
mkdir -p /etc/frp
wget -O /etc/frp/frps.ini https://raw.githubusercontent.com/kekoray/RaspberryPi-frp/main/frps.ini
wget -O /etc/systemd/system/frps.service https://raw.githubusercontent.com/kekoray/RaspberryPi-frp/main/frps.service
rm -r /tmp/frp 
