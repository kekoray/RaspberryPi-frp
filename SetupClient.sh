...
mkdir -p /etc/frp
wget -O /etc/frp/frpc.ini https://github.com/kekoray/RaspberryPi-frp/blob/main/frpc.ini
wget -O /etc/systemd/system/frpc.service https://github.com/kekoray/RaspberryPi-frp/blob/main/frpc.service
rm -r /tmp/frp