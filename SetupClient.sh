...
mkdir -p /etc/frp
wget -O /etc/frp/frpc.ini https://raw.githubusercontent.com/kekoray/RaspberryPi-frp/main/frpc.ini
wget -O /etc/systemd/system/frpc.service https://raw.githubusercontent.com/kekoray/RaspberryPi-frp/main/frpc.service
rm -r /tmp/frp
